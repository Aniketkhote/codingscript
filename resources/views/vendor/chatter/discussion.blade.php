...
<div id="chatter" class="discussion">
	...
	<p>
		...
		<span class="posted_by">{{ ucfirst($discussion->user->{Config::get('chatter.user.database_field_with_user_name')}) }}</span>
	</p>
	                		...
	                		<li data-id="{{ $post->id }}" data-markdown="{{ $post->markdown }}">
		                		<span class="chatter_posts">
		                			@if(!Auth::guest() && (Auth::user()->id == $post->user->id))
			                			...
			                			<div class="chatter_post_actions">
			                				<p class="chatter_delete_btn">
			                					<i class="chatter-delete"></i>
			                				</p>
			                				<p class="chatter_edit_btn">
			                					<i class="chatter-edit"></i>
			                				</p>
			                			</div>
			                		@endif
					        		...
					        		<div class="chatter_middle">
					        			<span class="chatter_middle_details"><a href="{{ \Webdevmatics\Chatter\Helpers\ChatterHelper::userLink($post->user) }}">{{ ucfirst($post->user->{Config::get('chatter.user.database_field_with_user_name')}) }}</a> <br><span class="ago chatter_middle_details text-muted">{{ \Carbon\Carbon::createFromTimeStamp(strtotime($post->created_at))->diffForHumans() }}</span></span>
