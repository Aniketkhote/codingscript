        ...
        <div class="card">
            <div class="card-header">
                ...
                <Button class="btn btn-default btn-md float-right"
                    href="{{ route('tag.create') }}">New</Button>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td class="titleHover">
                                    <a href="">
                                        ...
                                        <p>
                                            <a class="text-blue"
                                                href="{{ route('tag.edit', $tag -> id) }}">Edit</a>
                                            |
                                            <a class="text-red"
                                                onclick="event.preventDefault(); document.getElementById('delete-tag-{{ $tag -> id }}').submit();"
                                                href="">Delete</a>

                                            <form id="delete-tag-{{ $tag->id }}" method="post"
                                ...
                                <td>
                                    <?php 
                                       echo $postCount = TagController::postCount($tag->id)
                                    ?>
                                </td>
                            </tr>
                        @endforeach
