            ...
            <div class="col-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                        <input type="text" name="excerpt" value="{{ $post -> excerpt }}" class="form-control" placeholder="Enter Post Excerpt ...">
                        ...
                        <div class="form-group">
                            ...
                            <span class="btn btn-app btn-file" style="padding:50px;">
                                ...
                                <input id="file" name="thumbnail" value="{{ $post -> image }}" type="file" onchange="imgPreview(event)"
                                    class="form-control">
                            </span>
                            <span style="padding:50px;">
                                <img id="preview" name="thumb" src="{{ Storage::disk('local')->url($post->image) }}"
